...
/* Returns the area of the area of the triangle formed by the
three argument points */
double coord_2d_area_trangle(const coord_2d_t* a, const coord_2d_t* b, const coord_2d_t* c);
